...
if texto_1 > texto_2:
    print("El {} es mayor a {}".format(texto_1, texto_2))
else:
    print("El {} es mayor a {}".format(texto_2, texto_1))
...
if num_1 > num_2:
    print("El {} es mayor a {}".format(num_1, num_2))
else:
    print("El {} es mayor a {}".format(num_2, num_1))
# Para pensar!
